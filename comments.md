...
**No 🔴 blocking items open.** All items are minor / deferred / owner-config. M1 backend + M2 seed verified complete against the live project; M4 (salesman order flow): infra + primitives (96880f5) and the full S3–S6 create flow (97272b4) are in — ㉓/㉔ **closed** at 97272b4 (verified by execution); one 🟡 edit/resume display edge (㉕) open. S7 (order detail / edit / cancel / `order_events`) under review.
